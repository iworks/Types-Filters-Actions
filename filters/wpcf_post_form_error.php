...
<p>Location: <a href="http://iworks.pl/types/filters/wpcf_post_form_error.php">http://iworks.pl/types/filters/wpcf_post_form_error.php</a></p>

filter to remove is not used in current version of plugin

<!--
<a name="Description" id="Description"></a><h2>Description</h2>
<p>The <b>wpcf_post_form_error</b> filter is used to filter</p>
...
<p></p>
<pre>[code type="php"]
function my_wpcf_post_form_error($)
{
}
add_filter('wpcf_post_form_error', 'my_wpcf_post_form_error', 10, 1);
[/code]</pre>

<a name="Source_File" id="Source_File"></a><h2>Source File</h2>
<p>wpcf_post_form_error is located in: embedded/includes/fields-post.php.</p>

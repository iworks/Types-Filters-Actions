...
<p>Location: <a href="http://wp-types.com/documentation/user-guides/types-filters/wpcf_fields_slug_slug_value_display/">http://wp-types.com/documentation/user-guides/types-filters/wpcf_fields_slug_slug_value_display/</a></p>

<a name="Description" id="Description"></a><h2>Description</h2>
<p>The <b>wpcf_fields_slug_(slug)_value_display.html</b> filter is used to filter
the value of a meta field. This filter is called only for the specified field slug, just
...
<p>Hide the first part of a domain for a field with the slug "second-email":</p>
<pre>[code type="php"]
function my_wpcf_fields_slug_second_email_value_display($meta, $config, $post_ID, $field_ID, $meta_id)
{
    /**
...
add_filter('wpcf_fields_slug_second-email_value_display', 'my_wpcf_fields_slug_second_email_value_display', 10, 5);
[/code]</pre>
...
<ul>
    ...
    <li>filter: <a href="./wpcf_fields_type_type__value_display.html">wpcf_fields_slug_(slug)_value_display</a></li>
</ul>

...
<p>Location: <a href="http://wp-types.com/documentation/user-guides/types-filters/wpcf_access_types_caps/">http://wp-types.com/documentation/user-guides/types-filters/wpcf_access_types_caps/</a></p>
...
<p></p>
<pre>[code type="php"]
function my_wpcf_access_types_caps($)
{
}
add_filter('wpcf_access_types_caps', 'my_wpcf_access_types_caps', 10, 1);
[/code]</pre>

<a name="Source_File" id="Source_File"></a><h2>Source File</h2>
<p>wpcf_access_types_caps is located in: plus/types-access/embedded.php.</p>

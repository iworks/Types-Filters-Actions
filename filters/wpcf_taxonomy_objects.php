...
<p>Location: <a href="http://wp-types.com/documentation/user-guides/types-filters/wpcf_taxonomy_objects/">http://wp-types.com/documentation/user-guides/types-filters/wpcf_taxonomy_objects/</a></p>
...
<p></p>
<pre>[code type="php"]
function my_wpcf_taxonomy_objects($)
{
}
add_filter('wpcf_taxonomy_objects', 'my_wpcf_taxonomy_objects', 10, 1);
[/code]</pre>

<a name="Source_File" id="Source_File"></a><h2>Source File</h2>
<p>wpcf_taxonomy_objects is located in: embedded/includes/custom-taxonomies.php.</p>
